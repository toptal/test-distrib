...
RSpec.describe 'Failing after step' do
  ...
  specify do
    ...
    expect(leader.output).to include '5 steps (3 skipped, 2 passed)'
    ...
    expect(worker_outputs).to include match(/1 scenario \(1 failed\)/)
    expect(worker_outputs).to include match(/2 steps \(1 skipped, 1 passed\)/)
